...
const ParagraphWidget = ({widget, updateWidgetState,deleteWidget,previewWidget,moveUp,moveDown,isTop,isBottom,topicId}) => {
                                ...
                                <div className="col-sm-12">
                                    <textarea className="form-control"
                                                ...
                                                onChange={() => {widget.text = textarea.value 
                                                                 updateWidgetState(widget.id,widget)}}></textarea>
                                </div>
                            </div>
                            <div className="form-group row">
