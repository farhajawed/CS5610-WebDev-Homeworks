...
class TopicPills extends React.Component{
    ...
    componentDidUpdate(prevPros) {
        if(prevPros.lesson.id !== this.props.lesson.id) {
         TopicService.findTopic(this.props.lesson.id)
    ...
    addNewTopic = () => {
        ...
        TopicService.createTopic(this.props.lesson.id,newTopic).then(
    ...
    deleteTopic = (topicId) => {
        TopicService.deleteTopic(topicId)
          .then(() => {
              TopicService.findTopic(this.props.lesson.id).then(topics=>this.setState({
                              topics: topics
                       })
             )})
     }
